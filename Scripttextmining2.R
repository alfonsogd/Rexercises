...
cname <- file.path("C:", "Users", "Alfonso", "Documents", "Maricarmen")
#cname <- file.path(".")
cname
...
quitarpalabras <- c("Article", "article", "Annals", "Abstract", "abstract", 
                "Author", "author" ,"can", "the", "The", "also", 
                "annals", "articles", "annal", "Annal", "articled", 
                "issue", "keywords", "Keywords", "journal", "Journal", 
                "journals", "ISSN", "Issue", "issue", "keyword", "Keyword", 
                "Tourism", "Management", "Research", "Travel", "Volume", "volume",
                "VOLUME", "volumes", "Volumes", "VOLUMES", "this", "This",
                "httpwwwsciencedirectcomsciencearticlepiiS", "paper", 
                "Paper", "papers", "Papers", "httpjtrsagepubcomcontentfullpdfhtml", 
                "httpjtrsagepubcomcontentabstract",
                "httpdxdoiorgjtourman", "URL", "url", "Url", "DOI", "doi",
                "httpdxdoiorg", "httpwwwsciencedirectcomsciencearticlepii")
...
###### La siguiente linea se agregó para la segunda corrida
docs <- tm_map(docs, removeWords, c("analysi", "year", "titl", "page", "studi", 
                                    "may", "discuss", "present", "eprint",
                                    "httpdxdoiorgs", "Page"))
...
#document term matrix into a matrix and summing the column counts:
...
write.csv(m, file="dtm_maricarmen2.csv")
...
##Graficar NOTA: USA Rgraphviz que no existe en esta versión.
